...
const MainBody = () => {
  ...
  return (
    ...
    <div
      ...
      className="relative flex flex-col w-[90%] max-w-[300px] md:w-[75%] md:max-w-[1200px] md:h-5/6 md:min-h-5/6 lg:min-h-[700px] mx-auto gap-3 glass rounded-lg bg-center bg-cover py-5 overflow-scroll pb-3"
    >
