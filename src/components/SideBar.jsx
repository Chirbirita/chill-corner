...
function SideBar() {
  ...
  return (
    <div
      ...
      className="flex flex-col w-[90%] mx-auto max-w-[300px] lg:max-w-[350px] md:h-5/6 md:min-h-5/6 gap-5 relative glass my-auto rounded-lg py-5 justify-center bg-cover px-3"    >
